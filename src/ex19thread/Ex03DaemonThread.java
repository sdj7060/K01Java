...
class YesThread extends Thread {
	...
	해당 쓰레드의 이름을 지정할수 있다. 지정된 이름은 getName()
	을 통해 반환할수 있다.
	 */
...
종속쓰레드 (Daemon Thread)
	...
	주로 프로그램의 보조역할로 배경음악, 로그자동저장등의 업무를
...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		...
		*/
		YesThread yt1 = new YesThread("1st 쓰레드"); //생성자틑 통해 이름 부여
