...
class MyString implements Comparable<MyString> {
	...
	public int compareTo(MyString paramStr) {
		...
		if(getLenght() > paramStr.getLenght())
			return 1;
		else if(getLenght() < paramStr.getLenght())
			return -1;
		else
			return 0;
		//문자열의 알파벳 순서대로 정렬한다.
...
public class Ex04TreeSetMain {
	...
	public static void main(String[] args) {
		...
		tree1.add(2);
		tree1.add(3);
		System.out.println(tree1.add(2)); //Set는 중복저장 허용안됨
		...
		/*
		-문자열의 길이가 정렬의 기준일떄는 아래 객체중 7글자인 KOSMOXX는
			1개만 삽입된다.
