...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		List<E> 인터페이스 계열의 컬렉션
			...
			아래와같이 타입매개변수를 생략하면 모든 객체를 저장할수 있는
			컬렉션이 된다. 즉 ArrayList<Object>로 선언한 것과
			동일하다.
		 */
		...
		/*
		1-2] 중복저장
			: List는 배열의 속성을 가지므로 데이터는 중복이 허용된다.
		...
		1-3] 리스트 컬렉션 출력하기 (for, 확장for문)
			컬렉션을 다룰때는 주로 확장for(foreach)문을 사용한다.
		 */
		System.out.println("\n[일반for문 사용]");
