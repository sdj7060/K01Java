...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		배열의 선언과 동시에 초기화를 하는경우 자바 컴파일러는 초기값의 갯수를 통해 
		크기를 결정할 수 있으므로 이런경우 크기는 생략하도록 약속되어 있다.
		 */
		System.out.println("방법2 : 선언과 동시에 초기화");
		//int[] inirArr2 = new int[3] {1, 20, 300};
		int[] inirArray2 = new int[] {1, 20, 300};
		
		/*
		배열 요소의 갯수를 통해 배열을 즉시 생성한다. 이때 new키워드는 생략한다.
		 */
