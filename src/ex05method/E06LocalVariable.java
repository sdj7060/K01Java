...
/*
Local variable(지역변수)
	-변수는 사용범위(Scope)를 가지고있고, 해당 지역내에서만 사용가능하다.
...
public class E06LocalVariable {
	...
	public static void main(String[] args) {
		...
		boolean scope = true;
		/*
		main지역에서 num(변수)을 선언하면 그보다 작은 if문의 지역에서는 같은 이름의 변수를 선언할 수 없다.
	...
	/*
	main에서 선언한 변수 num이 메모리에 남아있지만, simpleFunc()메소드는 
	서로 다른 지역에 정의 되었으므로 같은 이름의 변수를 사용할수 있다.
	 */
