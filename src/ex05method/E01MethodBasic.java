...
-static으로 선언된 메소드는 static으로 선언된 메소드만 호출할수있다.
...
public class E01MethodBasic {
	...
	/*
	메소드정의1 : 반환타입O, 매개변수O 형태의 정의
		-> 두개의 정수를 전달받아 합 의 결과를 반환한다.
	 */
	...
	/*
	메소드정의2 : 반환타입X, 매개변수X 형태의 정의
		-> 전달되는 값 없이 이름을 입력받은후 namePrint()함수를 호출한다.
	...
	public static void main(String[] args) {
		...
		매개변수가 있다면 갯수만큼 포함시켜주면된다.
		매개변수의 갯수가 다르면 호출되지않고 에러가 발생한다.
		 */
