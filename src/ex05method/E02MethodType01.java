...
Java에서의 Naming rule(이름규칙)
	...
	-패키지명 : simple.func -> 전체를 소문자로 표현하고, 연결된 단어가 있더라고 언더바를 사용하지 않는다.
							언더바대신 .(닷 혹은 점)을 사용한다.
 */
...
public class E02MethodType01 {
	...
	static void noParamNoReturn3() {
		...
		//return;
		/*
		위와 같이 함수 중간에 return을 쓰게되면 함수가 즉시종료되므로
		아래문장은 실행되지 않는 쓰레기코드가 된다. 반드시 조건문과 함께 사용되어야 한다.
