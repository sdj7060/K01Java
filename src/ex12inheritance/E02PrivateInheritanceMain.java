...
class SavingAccount extends Account{
	...
	이때 인자가 하나인 생성자 메소드를 호출하게 된다.
	 */
	public SavingAccount (int intiVal) {
		super(intiVal);
	}
...
public class E02PrivateInheritanceMain {
	...
	public static void main(String[] args) {
		...
		/*
		private멤버이므로 상속받은 하위클래스의 참조변수를 통해서는 접근이 불가능하다.
