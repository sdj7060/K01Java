...
//	}
	...
	/*
	해당 메소드를 protected로 선언하면 상속관계의 하위 객체에서 호출할 수 있다.
	 */
	...
	/*
	해당 메소드는 내부에서만 접근되므로 호출순서를 지켜 실행할수 있도록 캡슐화하여 정의 하였다.
	 */
}
/*
컴퓨터를 상속한 노트북컴퓨터
	: 컴퓨터가 가지고있는 기본기능에 휴대이용 부분을 확장하여 정의함.
...
class NotebookComputer extends Computer {
	...
	public NotebookComputer(String name, int initCharge) {
		/*
		여기서 super(name)을 삭제하게 되면 에러가 발생된다.
		부모클래스에서 인자생성자를 정의하였기 때문에 기본생성자는 생성되지 않기 때문이다.
		 */
		super(name);
		battary = initCharge;
	}
